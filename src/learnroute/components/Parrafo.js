...
export default function Parrafo({ id, selected, data: { content = "Contenido del párrafo", colorText = "#000000", backgroundColor = "", fontSize = 16, borderColor = '#ccc', measured = { width: 300, height: 150 }, fontFamily = 'Arial', }, }) {
    ...
    return (_jsxs("div", { style: {
        ...
        }, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false), children: [content, _jsx(NodeResizeControl, { minWidth: 200, minHeight: 100, position: "bottom-right", onResize: handleResize, style: { background: 'transparent', border: 'none' }, children: selected && (_jsx("div", { style: {
                        width: '10px',
                        height: '10px',
