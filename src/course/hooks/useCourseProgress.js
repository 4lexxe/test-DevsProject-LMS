...
import { getCourseProgress, getUserProgress, accessContent, markContentCompleted } from '../services/progressService';
/**
...
export const useCourseProgress = (courseId) => {
    ...
    const handleContentAccess = useCallback(async (contentId, timeSpent) => {
        try {
    ...
    const handleContentComplete = useCallback(async (contentId, timeSpent) => {
        try {
 ...
 */
export const useProgressStats = (courseProgress) => {
    const stats = {
